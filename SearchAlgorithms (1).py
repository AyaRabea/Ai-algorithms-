...
class SearchAlgorithms:
    ...
    def load(self):
        ...
        size=len(self.maze)#size of string(maza el da5la)
        ...
        for r in range(0,len(listrowmaze)):
            ...
            for c in range(0,len(listrowmaze[r])):
                ...
                if r+1 < len(listrowmaze):#check goa al maze
                    nnode.down=count+len(listrowmaze[r])#plus 3dd al col(len(listrowmaze[r]))
                else:
                    nnode.down =None
                if r-1 >= 0:#left#check goa al maze
                    nnode.top=count-len(listrowmaze[r])#tr7 3dd al col
                else:
                    nnode.top=None
                if c+1 < len(listrowmaze[r]):
                    nnode.right=count+1#count hwa al id
                ...
                if c-1 >= 0:
                    ...
                    nnode.left=None
                map[count]=nnode
                listnode.append(nnode)#bt4el row row
                count+=1
            fullmaze.append(listnode.copy())#kol elements node
                ...
                if start.top != None:
                    if fullmaze[it][jt].value == '.' or fullmaze[it][jt].value == 'E':
                        if fullmaze[it][jt].visit == False:
                            ...
                            fullmaze[it][jt].visit = True
                            fullmaze[it][jt].previousNode = start.id
                            fullmaze[it][jt].gOfN = start.gOfN + fullmaze[it][jt].edgeCost
                        else:

                            cal = start.gOfN + fullmaze[it][jt].edgeCost
                ...
                if start.down != None:
                    if fullmaze[id][jd].value == '.' or fullmaze[id][jd].value == 'E':
                        if fullmaze[id][jd].visit == False:
                            ...
                            fullmaze[id][jd].visit = True
                            fullmaze[id][jd].previousNode = start.id
                            fullmaze[id][jd].gOfN = start.gOfN + fullmaze[id][jd].edgeCost

                        else:
                            cal = start.gOfN + fullmaze[id][jd].edgeCost
                ...
                if start.right != None:
                    if fullmaze[ir][jr].value == '.' or fullmaze[ir][jr].value == 'E':
                        if fullmaze[ir][jr].visit == False:
                            ...
                            fullmaze[ir][jr].visit = True
                            fullmaze[ir][jr].previousNode = start.id
                            fullmaze[ir][jr].gOfN = start.gOfN + fullmaze[ir][jr].edgeCost

                        else:
                            cal = start.gOfN + fullmaze[ir][jr].edgeCost
                ...
                if start.left != None:
                    if fullmaze[il][jl].value == '.' or fullmaze[il][jl].value == 'E':
                        if fullmaze[il][jl].visit == False:
                            ...
                            fullmaze[il][jl].visit = True
                            fullmaze[il][jl].previousNode = start.id
                            fullmaze[il][jl].gOfN = start.gOfN + fullmaze[il][jl].edgeCost


                        else:
                            cal = start.gOfN + fullmaze[il][jl].edgeCost
